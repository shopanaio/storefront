...
`@shopana/next-ecommerce-core` lets you build e‑commerce pages by composing templates (TypeScript objects) with your own layouts, sections, and blocks, while keeping all data strictly typed end‑to‑end.
...
Use `@shopana/next-ecommerce-core` when you need:
...
- use the provided types and SDK hooks from `@shopana/next-ecommerce-core`.
...
import type { BlockProps } from '@shopana/next-ecommerce-core/core';
...
import type { SectionProps } from '@shopana/next-ecommerce-core/core';
import { useShop } from '@shopana/next-ecommerce-core/sdk';
import type { ProductTemplateData } from '@shopana/next-ecommerce-core/sdk';
...
From `@shopana/next-ecommerce-core/core` you get the main building‑block types:
...
1. **Install dependencies**  
   Add `@shopana/next-ecommerce-core` to your Next.js App Router project and ensure peer dependencies are satisfied.
