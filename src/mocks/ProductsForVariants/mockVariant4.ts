...
export const mockVariant4: ApiProduct = {
  __typename: 'Product',
  handle: 'variant-4',
  ...
  options: [{
    ...
    value: {
      ...
      title: "T-Short 2",
      handle: 't-shirt-2',
      id: 'witcher-box-t-short-2',
      iid: 'witcher-box-t-short-2',
      style: {
        ...
        image: {
          ...
          url: "https://kashalot.gift/image/cachewebp/catalog/Witcher/Futbolki_Witcher/1-600x600.webp",
        },
      },
    },
  }, {
    ...
    value: {
      ...
      title: "M",
      handle: 'm',
      id: 'witcher-box-size-2',
      iid: 'witcher-box-size-2',
      style: {
