...
export const mockColorVariant3: ApiProduct = {
  __typename: 'Product',
  handle: 'witcher',
  title: 'Зілля Ролафа',
  id: "color-variant-id-3",
  iid: 'color-variant-uuid-3',
  options: [{
    ...
    value: {
      ...
      title: "Зілля Ролафа",
      handle: 'rolafs potion',
      id: 'witcher-box-color-3',
      iid: 'witcher-box-color-3',
      style: {
