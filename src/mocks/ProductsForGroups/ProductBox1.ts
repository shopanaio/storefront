...
export const mockProductBox1: ApiProduct = {
  __typename: 'Product',
  title: 'Gift',
  cover: {
    __typename: "File",
    ...
    url: "https://kashalot.gift/image/cachewebp/catalog/Witcher-2022/witcher-box-premium-2022-600x600.webp",
  },
  averageRating: 5,
