...
export const mockProductCup1: ApiProduct = {
  __typename: 'Product',
  title: 'Керамическая, с артом',
  cover: {
    __typename: "File",
    id: "file-1",
    iid: "uuid-file-1",
    source: MediaSource.Url,
    url: "https://kashalot.gift/image/cachewebp/catalog/Witcher-2022/cup-keramica-witcher%20-%202-2022-600x600.webp",
  },
  averageRating: 5,
