...
export const mockSet3: ApiProduct = {
  __typename: 'Product',
  title: 'Открытка',
  handle: 'witcher-envelope',
  id: "product-id-set-3",
  iid: 'product-uuid-set-3',
  cover: {
    __typename: "File",
    id: "file-1",
    iid: "uuid-file-1",
    source: MediaSource.Url,
    url: "https://kashalot.gift/image/cachewebp/catalog/Witcher-2022/otkr-witcher-a5-2022-1500x1500.webp",
  },
  averageRating: 5,
  ...
  description: 'Открытка в декорированом конверте с персонажами Ведьмака.',
