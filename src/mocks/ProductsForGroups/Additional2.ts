...
export const mockAdditional2: ApiProduct = {
  __typename: 'Product',
  ...
  cover: {
    ...
    url: "https://kashalot.gift/image/cachewebp/catalog/Witcher-2022/checanaya-moneta-witcher-2022-600x600.webp",
  },
  averageRating: 5,
  ...
  groups: [],
  handle: 'witcher',
  id: "additional-product-id-2",
  iid: 'additional-product-uuid-2',
  options: [],
