...
export const mockAdditional5: ApiProduct = {
  __typename: 'Product',
  title: 'Игровое поле для Гвинт',
  cover: {
    __typename: "File",
    id: "file-1",
    iid: "uuid-file-1",
    source: MediaSource.Url,
    url: "https://kashalot.gift/image/cachewebp/catalog/Witcher/Igrovoe_pole_dlya_kartochnoy_igry_Gwent/1-600x600.webp",
  },
  averageRating: 5,
  ...
  groups: [],
  handle: 'witcher',
  id: "additional-product-id-5",
  iid: 'additional-product-uuid-5',
  options: [],
