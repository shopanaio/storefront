...
export const mockAdditional4: ApiProduct = {
  __typename: 'Product',
  title: 'Деревянная коробка ║ Gwent',
  cover: {
    __typename: "File",
    id: "file-1",
    iid: "uuid-file-1",
    source: MediaSource.Url,
    url: "https://kashalot.gift/image/cachewebp/catalog/Gwent-20-New/gwent-20-box-1-600x600.webp",
  },
  averageRating: 5,
  ...
  groups: [],
  handle: 'witcher',
  id: "additional-product-id-4",
  iid: 'additional-product-uuid-4',
  options: [],
