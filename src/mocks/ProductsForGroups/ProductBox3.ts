...
export const mockProductBox3: ApiProduct = {
  __typename: 'Product',
  title: '⭐️ Premium',
  cover: {
    __typename: "File",
    ...
    url: "https://kashalot.gift/image/cachewebp/catalog/Witcher-2022/witcher-box-premium-UPAKOVKA-2022-600x600.webp",
  },
  averageRating: 5,
