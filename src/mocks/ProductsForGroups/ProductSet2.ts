...
export const mockSet2: ApiProduct = {
  __typename: 'Product',
  title: 'Tea "Swallow"',
  handle: 'witcher-tea',
  id: "product-id-set-2",
  iid: 'product-uuid-set-2',
  cover: {
    __typename: "File",
    id: "file-1",
    iid: "uuid-file-1",
    source: MediaSource.Url,
    url: "https://kashalot.gift/image/cachewebp/catalog/Witcher-2022/lastochka-2022-1-1500x1500.webp",
  },
  averageRating: 5,
  ...
  description: 'Чай «Ласточка» в стеклянной бутылке. Внутри: фруктовый чай с яблоками, ананасами и апельсинами, вкус которого подчеркивают каркаде, роза, шиповник, малина и рябина.',
