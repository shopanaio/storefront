...
export const mockAdditional3: ApiProduct = {
  __typename: 'Product',
  title: 'Руководство по Гвинту',
  cover: {
    __typename: "File",
    id: "file-1",
    iid: "uuid-file-1",
    source: MediaSource.Url,
    url: "https://kashalot.gift/image/cachewebp/catalog/Gwent-20-New/gwent-20-reg1-600x600.webp",
  },
  averageRating: 5,
  ...
  groups: [],
  handle: 'witcher',
  id: "additional-product-id-3",
  iid: 'additional-product-uuid-3',
  options: [],
