...
export const mockProductBox2: ApiProduct = {
  __typename: 'Product',
  title: 'Подарочная ║ Wild Hunt',
  cover: {
    __typename: "File",
    id: "file-1",
    iid: "uuid-file-1",
    source: MediaSource.Url,
    url: "https://kashalot.gift/image/cachewebp/catalog/Witcher-2022/witcher-new-box-printed-600x600.webp",
  },
  averageRating: 5,
