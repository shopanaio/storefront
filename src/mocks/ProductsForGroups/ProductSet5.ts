...
export const mockSet5: ApiProduct = {
  __typename: 'Product',
  title: 'Notebook',
  handle: 'witcher-note-book',
  id: "product-id-set-5",
  iid: 'product-uuid-set-5',
  cover: {
    __typename: "File",
    id: "file-1",
    iid: "uuid-file-1",
    source: MediaSource.Url,
    url: "https://kashalot.gift/image/cachewebp/catalog/Witcher-2022/bloknot-witcher-2022-1500x1500.webp",
  },
  averageRating: 5,
  ...
  description: 'Incredibly beautiful notebook cover has a leather texture, on which the embossed Witcher emblem and the inscription "The Witcher" appear. The notebook has silver metal corners, which gives it a special touch.',
