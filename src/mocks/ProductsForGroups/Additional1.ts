...
export const mockAdditional1: ApiProduct = {
  __typename: 'Product',
  title: 'Амулет Ведьмака',
  cover: {
    __typename: "File",
    id: "file-1",
    iid: "uuid-file-1",
    source: MediaSource.Url,
    url: "https://kashalot.gift/image/cachewebp/catalog/Witcher-2022/amuletWolf_Witcher_8-600x600.webp",
  },
  averageRating: 5,
  ...
  groups: [],
  handle: 'witcher',
  id: "additional-product-id-1",
  iid: 'additional-product-uuid-1',
  options: [],
