...
export const mockSet4: ApiProduct = {
  __typename: 'Product',
  title: 'Чашка',
  handle: 'witcher-cup',
  id: "product-id-set-4",
  iid: 'product-uuid-set-4',
  cover: {
    __typename: "File",
    id: "file-1",
    iid: "uuid-file-1",
    source: MediaSource.Url,
    url: "https://kashalot.gift/image/cachewebp/catalog/Witcher-2022/cup-keramica-witcher%20-%202-2022-1500x1500.webp",
  },
  averageRating: 5,
  ...
  description: 'Тематическая чашка: • Керамическая, принт устойчивый',
