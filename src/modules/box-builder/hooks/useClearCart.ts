...
export const useClearCart = () => {
  ...
  const [commit, isInFlight] = useMutation<ClearCartLinesMutationType>(
    clearCartLinesMutation
  );
  ...
  const clearSelectedCardIds = useBoxBuilderStore(
    (s) => s.clearSelectedCardIds
  );
